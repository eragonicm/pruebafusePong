<?php 
    ...
    $ProjectData=mysqli_query($con, "select * from proyecto");
    $historia=mysqli_query($con, "select * from historia_usuario");
                ...
                <div class="row top_tiles">
                    ...
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          ...
                          <div class="count"><?php echo mysqli_num_rows($historia) ?></div>
