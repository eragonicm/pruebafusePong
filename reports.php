<?php
    ...
    $projects = mysqli_query($con, "select * from proyecto");
    ...
    <div class="right_col" role="main"><!-- page content -->
                                ...
                                <div class="input-group">
                                    ...
                                    <option value="">PROYECTO</option>
                                      <?php foreach($projects as $p):?>
                                        <option value="<?php echo $p['id']; ?>" <?php if(isset($_GET["project_id"]) && $_GET["project_id"]==$p['id']){ echo "selected"; } ?>><?php echo $p['nombre']; ?></option>
                                      <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
        ...
        <div class="x_content">
            ...
            foreach($users as $user){
                ...
                $category=mysqli_query($con, "select * from historia_usuario where id=$category_id");
                $kinds = mysqli_query($con,"select * from kind where id=$kind_id");
                $project  = mysqli_query($con, "select * from proyecto where id=$project_id");
