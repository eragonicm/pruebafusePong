            ...
            <table class="table table-striped jambo_table bulk_action">
                <thead>
                    <tr class="headings">
                        ...
                        <th class="column-title">Historia de usuario </th>
                ...
                <?php 
                        while ($r=mysqli_fetch_array($query)) {
                            ...
                            $sql = mysqli_query($con, "select * from proyecto where id=$project_id");
                            if($c=mysqli_fetch_array($sql)) {
                                $name_project=$c['nombre'];
                            }

                            $sql = mysqli_query($con, "select * from historia_usuario where id=$category_id");
                            if($c=mysqli_fetch_array($sql)) {
                                $name_historia=$c['nombre'];
                            }
