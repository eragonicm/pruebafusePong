        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus-pencil"></i> Editar Historia de usuario</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal form-label-left input_mask" method="post" id="upd" name="upd">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Prioridad <span class="required">*</span>
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                            <select class="form-control" name="mod_prioridad" id="mod_prioridad">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Programador Responsable<span class="required">*</span>
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                            <select class="form-control" name="mod_usuario" id="mod_usuario">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <textarea name="mod_descripcion" id="mod_descripcion" class="date-picker form-control col-md-7 col-xs-12" required placeholder="Descripción"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Proyecto<span class="required">*</span>
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                            <select class="form-control" name="mod_proyecto" id="mod_proyecto">
